...
function StatCounter({
  ...
  return (
    <div className="relative group flex flex-col items-center text-center p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
      <div className={`absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-10 ${color}`} />
  ...
  const steps = [
    {
      ...
      flipDesc: "Filter by date, category, location and more. Save favorites, set reminders, and get personalized recommendations based on your interests.",
      icon: Calendar,
    ...
    },
    {
      ...
      flipDesc: "Multiple payment options including UPI, cards, net banking, and wallets. Your transaction is protected with bank-grade 256-bit SSL encryption.",
      icon: CreditCard,
    ...
    },
    {
      ...
      flipDesc: "Your encrypted QR ticket works offline, updates in real-time, and contains all event details. Add it to Apple Wallet or Google Pay instantly.",
      icon: QrCode,
    ...
    },
    {
      ...
      flipDesc: "Sub-second QR scanning. Dynamic codes prevent duplication. VIP zone access, activity-based permissions — all managed in one place.",
      icon: ScanLine,
  ...
  const testimonials = [
    {
      ...
      avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuAZ3Qo4A-062yU7THWeNPbSCX2QpWW-y_PgoDRkIW-BiFdOd3uqFhfQE0mJtLo1ZzS_ajHsljwAA3HBcot3ne2ySku0EU1GmI5QrPRtkIFRma1bolvEOr0gZRfR1dDQUMGONfA6_pkdhue8VmXH9nfhkYCSpNyzh4h_CysMFsh1BUsFRMGIeVsfspGnjRcX9F-EF9JUfc-6aDWh9NwO2qramQiP_Zb8UtEQZriEX9QpYVUHIo1UP-2UzL8WtLUaN5gwGJn17d9W9BE",
    ...
    },
    {
      name: "Sneha Patel",
      role: "Food Blogger",
      avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuBCjBeU35tEZpuf7yK3iXD9O3kuE_zDwGTzUg3dWhrG7W62AlOLU5k6uY9bcpR7DSwGsLYRMcPoMYpvvBPwr8s27Ejt9N4dG5CdBkt9_la81eiHkfJjSthxdbzNqthKYUqdKoOP49qh39nAfh8ofcAFV7xHr0xipCBWxbZUt8CPpZOQaTvoY2dwHFpibwbtKA9sr06mIXzDUqP5U9s5vZt-bdwXSdxm22FkX-JthmiQ0VAjNtSNHU5gjFzxxEjs3aS2jLvCfXHsans",
  ...
  return (
    <div className="min-h-screen bg-[#f8f9ff] font-sans text-slate-900 overflow-x-hidden">
      ...
      {/* ═══════════════════════════════════════════
          HERO SECTION
      ═══════════════════════════════════════════ */}
      <section id="home" className="hero-bg pt-32 pb-24 px-6 overflow-hidden min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 fade-in-up">
            ...
            <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-lg">
              ...
              friction — powered by encrypted QR technology and real-time cloud sync.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                {[
                  ...
                  <img key={i} src={src} className="w-10 h-10 rounded-full border-2 border-white object-cover shadow-md" />
                ))}
              </div>
              <div>
                ...
                <p className="text-sm font-bold text-slate-700">50,000+ happy attendees</p>
              </div>
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute -left-6 top-20 card-glass px-4 py-3 rounded-2xl shadow-xl flex items-center gap-3 z-20 hidden lg:flex">
              ...
              <div>
                <p className="text-xs font-black text-slate-900">Ticket Verified</p>
                <p className="text-[10px] text-slate-500 font-medium">Gate A — Admitted</p>
              </div>
            </div>
            ...
            <div className="absolute -right-4 bottom-28 card-glass px-4 py-3 rounded-2xl shadow-xl flex items-center gap-3 z-20 hidden lg:flex">
              ...
              <div>
                <p className="text-xs font-black text-slate-900">Trending Now</p>
                <p className="text-[10px] text-slate-500 font-medium">+230 booked today</p>
              </div>
            </div>

            {/* Phone frame */}
            <div className="relative mx-auto w-72 h-[580px] bg-slate-900 rounded-[52px] p-3 shadow-[0_60px_120px_-20px_rgba(124,58,237,0.35)] border-[7px] border-slate-800 float-phone pulse-glow z-10">
              {/* Notch */}
              ...
              <div className="w-full h-full bg-white rounded-[40px] overflow-hidden flex flex-col relative">
                ...
                <div className="px-7 pt-5 pb-2 flex justify-between items-center bg-white">
                  <span className="text-xs font-bold text-slate-900">9:41 AM</span>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-5 gap-6">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-violet-600 to-purple-700 text-white rounded-full shadow-lg shadow-violet-600/25">
                      ...
                      <span className="text-xs font-black uppercase tracking-widest">Verified Ticket</span>
                    </div>
                    <div className="text-center">
                      <p className="text-sm font-bold text-slate-900">Ready to Scan</p>
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Access Granted</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 border-t border-slate-50 bg-slate-50/50">
                  <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-violet-100 shadow-sm">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider">Gate Access</p>
                        <p className="text-xs font-bold text-slate-900">Zone A • Main Entrance</p>
                      </div>
                    </div>
      ...
      <section className="py-20 px-6 bg-white" ref={statsRef.ref}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCounter value={50} suffix="K+" label="Happy Attendees" icon={Users} color="bg-violet-600" inView={statsRef.inView} />
            <StatCounter value={1200} suffix="+" label="Events Hosted" icon={Calendar} color="bg-pink-600" inView={statsRef.inView} />
            <StatCounter value={98} suffix="%" label="Satisfaction Rate" icon={Star} color="bg-amber-500" inView={statsRef.inView} />
            <StatCounter value={200} suffix="+" label="Cities Covered" icon={Globe} color="bg-emerald-600" inView={statsRef.inView} />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#f0f2ff]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-4">
            <div>
              <span className="text-xs font-black uppercase tracking-widest text-violet-600 mb-3 inline-block">Browse Categories</span>
              <h2 className="text-4xl md:text-5xl font-black section-title leading-tight">
                Find Your<br />Perfect Experience
              </h2>
            </div>
            <Link to="/category" className="group flex items-center gap-2 text-violet-600 font-bold hover:gap-3 transition-all">
              All Categories <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
                ...
                front={
                  <div className="w-full h-full relative category-card overflow-hidden rounded-3xl">
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end">
                      ...
                      <span className="text-white/70 text-xs font-bold mb-1">{cat.count} Events</span>
                      <h3 className="text-white font-black text-xl leading-tight">{cat.label}</h3>
                      <p className="text-white/60 text-xs mt-2">Hover to explore →</p>
                    </div>
                  </div>
                }
                back={
                  <div className={`w-full h-full bg-gradient-to-br ${cat.backGradient} rounded-3xl p-6 flex flex-col justify-between`}>
                    <div>
                      ...
                      <p className="text-white/80 text-sm font-medium mb-4">{cat.count} events available</p>
                    </div>
                    <div className="space-y-2">
                      {cat.tags.map((tag, j) => (
                        <div key={j} className="flex items-center gap-2 text-white/90 text-sm font-semibold">
      ...
      <section id="how-it-works" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs font-black uppercase tracking-widest text-violet-600 mb-3 inline-block">The Process</span>
            <h2 className="text-4xl md:text-5xl font-black section-title mb-4">Simple 4-Step Process</h2>
            <p className="text-slate-500 font-medium text-lg max-w-xl mx-auto">
              Getting into your favourite events has never been this easy. Hover over each step to learn more.
            </p>
          </div>
                ...
                <div className="relative w-full h-full transition-transform duration-700 transform-style-3d group-hover:rotate-y-180">
                  ...
                  <div className="absolute inset-0 backface-hidden">
                    <div className="h-full p-7 rounded-3xl border border-slate-100 bg-slate-50/60 hover:shadow-xl step-card flex flex-col justify-between">
                      <div>
                        <span className="text-6xl font-black text-slate-100 absolute top-4 right-6 select-none">{step.step}</span>
                        <div className={`${step.lightBg} ${step.textColor} w-14 h-14 rounded-2xl flex items-center justify-center mb-5 feature-icon`}>
                          <step.icon className="w-7 h-7" />
                        </div>
                        <h3 className="text-xl font-black mb-2">{step.title}</h3>
                        <p className="text-sm text-slate-500 font-medium leading-relaxed">{step.desc}</p>
                      </div>
                      <p className="text-xs text-slate-400 font-semibold mt-3">Hover to learn more →</p>
                    </div>
                  </div>
                  {/* Back */}
                  <div className="absolute inset-0 backface-hidden rotate-y-180">
                    <div className={`h-full p-7 rounded-3xl bg-gradient-to-br ${step.gradient} flex flex-col justify-between`}>
                      <div>
                        <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
                          <step.icon className="w-6 h-6 text-white" />
                        </div>
                        <h3 className="text-xl font-black text-white mb-3">{step.title}</h3>
                        <p className="text-white/85 text-sm font-medium leading-relaxed">{step.flipDesc}</p>
                      </div>
                      <span className="text-white/60 text-xs font-bold uppercase tracking-widest">Step {step.step}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="events" className="py-24 px-6 bg-[#f0f2ff]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6">
            <div>
              <span className="text-xs font-black uppercase tracking-widest text-violet-600 mb-3 inline-block">Don't Miss Out</span>
              <h2 className="text-4xl md:text-5xl font-black section-title">
                Upcoming Live<br />Experiences
              </h2>
              <p className="text-slate-500 font-medium mt-3">Find your next adventure from our community's top events.</p>
            </div>
            <Link to="/events">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs font-black uppercase tracking-widest text-violet-600 mb-3 inline-block">Platform Features</span>
            <h2 className="text-4xl md:text-5xl font-black section-title mb-4">Why Choose Orboevents?</h2>
            <p className="text-slate-500 font-medium text-lg max-w-2xl mx-auto">
              We connect millions of event-goers with incredible experiences every day, powered by cutting-edge technology.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feat, i) => (
              <div key={i} className="group grid-feature-card bento-card bg-slate-50 hover:bg-white border border-slate-100 rounded-3xl p-8 flex flex-col gap-5 cursor-default">
                <div className={`feature-icon w-14 h-14 bg-gradient-to-br ${feat.gradient} rounded-2xl flex items-center justify-center shadow-lg`}>
                  <feat.icon className="w-7 h-7 text-white" />
                </div>
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-black text-lg text-slate-900">{feat.title}</h4>
                    <span className="text-xs font-black text-violet-600 bg-violet-50 px-3 py-1 rounded-full">{feat.stat}</span>
                  </div>
      ...
      <section className="py-24 px-6 bg-[#f0f2ff]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs font-black uppercase tracking-widest text-violet-600 mb-3 inline-block">Social Proof</span>
            <h2 className="text-4xl md:text-5xl font-black section-title mb-4">Loved by Event-Goers</h2>
            <p className="text-slate-500 font-medium text-lg">Hover over the cards to read full testimonials.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <FlipCard
                ...
                front={
                  <div className="w-full h-full bg-white rounded-3xl p-8 flex flex-col justify-between border border-slate-100 testimonial-card">
                    <div>
                      ...
                      <p className="text-slate-700 font-medium leading-relaxed text-sm line-clamp-4">"{t.text}"</p>
                    </div>
                ...
                back={
                  <div className={`w-full h-full bg-gradient-to-br ${t.gradient} rounded-3xl p-8 flex flex-col justify-between`}>
                    <div>
                      <Award className="w-8 h-8 text-white/70 mb-4" />
                      <p className="text-white font-medium leading-relaxed text-sm">"{t.text}"</p>
                    </div>
                    <div>
                      <p className="text-white font-black">{t.name}</p>
                      <p className="text-white/70 text-xs font-semibold">{t.event}</p>
                    </div>
                  </div>
                }
              />
      ...
      ═══════════════════════════════════════════ */}
      <section id="contact" className="py-24 px-6 bg-slate-900 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            <div>
              <span className="text-xs font-black uppercase tracking-widest text-violet-400 mb-3 inline-block">Why Orboevents</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { icon: Clock, title: "No long queues", desc: "Average entry time reduced by 70% with QR scanning." },
                { icon: Smartphone, title: "Digital tickets", desc: "Eco-friendly, never lost, always in your pocket." },
                { icon: ShieldCheck, title: "Secure validation", desc: "Anti-spoofing technology active on every scan." },
                { icon: Zap, title: "Easy upgrades", desc: "Upgrade seats or zones in one tap, anytime." },
              ].map((item, i) => (
            ...
            <div className="relative w-80 h-96 bg-white rounded-3xl p-8 flex flex-col items-center justify-center text-slate-900 gap-8 shadow-[0_0_80px_rgba(124,58,237,0.3)]">
              ...
              <div className="text-center space-y-2">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-green-50 rounded-full mb-2">
                  ...
                  <span className="text-green-700 text-xs font-bold">Live & Encrypted</span>
                </div>
                <p className="text-xs font-black uppercase tracking-widest text-violet-600">Scan for Access</p>
                <p className="text-[10px] text-slate-400 font-bold">ORBOEVENTS SECURE SYSTEM</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative cta-gradient rounded-[48px] overflow-hidden p-16 text-center shadow-2xl shadow-violet-900/30">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/15 backdrop-blur-sm rounded-full border border-white/20 mb-6">
                ...
                <span className="text-white text-xs font-bold uppercase tracking-widest">Join 50,000+ event-goers</span>
              </div>
              ...
              <p className="text-white/80 text-lg font-medium mb-10 max-w-xl mx-auto">
                Say goodbye to paper tickets, long queues, and event anxiety. Join the future of event access today.
              </p>
