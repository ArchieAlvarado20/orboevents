...
export default function EventType() {
  ...
  const handleDeleteEventType = (eventTypes: any) => {
    confirmToast("Delete this category?", async () => {
      await deleteEventType(eventTypes._id);
    });
  };

  const handleEditEventType = (eventTypes: EventTypeFormData) => {
        ...
        >
          ...
          <header className=" w-full border-slate-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-4 md:px-1 py-2">
            ...
            >
              ...
              <span className="hidden sm:inline">Add Event Types</span>
            </Button>
          </header>
